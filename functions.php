...
function foundation_scripts() {
	...
	wp_enqueue_style( 'foundation_css', get_template_directory_uri() . '/node_modules/foundation-sites/dist/css/foundation.min.css' );
	...
	wp_enqueue_script( 'foundation_js', get_template_directory_uri() . '/node_modules/foundation-sites/dist/js/foundation.min.js');
